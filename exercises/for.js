...
function forfunction(){
    ...
    var array1 = ["Hola", "mundo", "hola", "mundo", "hola"];
    ...
    for (var i = 0; i < array1.length; i++) {
        alert(array1[i].substring(0, 1).toUpperCase() + array1[i].substring(1, array1[i].length));
    }
    //
    ...
    // d. Crear una array vacío y con un bucle for de 10 repeticiones. Llenar el array con el número de la repetición, es decir que al final de la ejecución del bucle for debería haber 10 elementos dentro del array, desde el número 0 hasta al número
    var array2 = [];
    for (var i = 0; i < 10; i++) {
        array2.push(i);
    }
